...
namespace WindowsFormsApp1
{
    public partial class eraseschedule : Form
    {
        ...
        private void eraseschedule_Load(object sender, EventArgs e)
        {
        ...
        private void cancelbutton_Click(object sender, EventArgs e)
        {
            ...
            cmdcancel.CommandText = "UPDATE [" + classroom + "] SET [" + timecomboBox.Text + "] = 'Available' Where Day = '" + datecomboBox.Text + "';";
            cmdcancel.CommandType = CommandType.Text;
            cmdcancel.Connection = cnnoledb;
